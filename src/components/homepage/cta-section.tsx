      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2 }}>
          <Link href={buttonLink}
            className="group inline-flex items-center gap-3 bg-[#a7d26d] text-[#0C130B] px-8 py-4 text-lg font-medium tracking-wide hover:shadow-[0_0_40px_rgba(167,210,109,0.2)] transition-all duration-300"
          >
            {buttonText}
        ...
        <motion.a href="tel:+212661903077"
          className="mt-8 inline-block font-mono text-base text-white/15 hover:text-[#a7d26d] transition-colors duration-300"
